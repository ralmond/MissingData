...
```{r tests}
anything <- 12
testthat::expect_true(is.na(NA + anything))

testthat::expect_true(is.na(exp(NA)))

testthat::expect_true(is.na(mean(c(1,2,NA))))

testthat::expect_true(!is.na(mean(c(1,2,NA),na.rm=TRUE)))
```
